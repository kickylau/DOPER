...
class NewReservation(FlaskForm):
    ...
    address = StringField("Address", validators=[InputRequired(message="Please provide the address between length of 5-500 to pick up your pet"), Length(min=5, max=500)])

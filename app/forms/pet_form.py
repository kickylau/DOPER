...
class NewPet(FlaskForm):
    ...
    size = IntegerField("Size", validators=[InputRequired(), NumberRange(min=0,message="Size has to be a positive integer")])
    ageYear = IntegerField("Age(Year)", validators=[InputRequired(), NumberRange(min=0,message="Age has to be a positive integer")])
    ageMonth = IntegerField("Age(Month)", validators=[InputRequired(), NumberRange(min=0,message="Month has to be a positive integer")])

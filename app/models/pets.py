...
class Pet(db.Model):
    ...
    has_microchipped = db.Column(db.String, nullable=False)
    has_spayed = db.Column(db.String, nullable=False)
    has_trained = db.Column(db.String, nullable=False)
    ...
    reservations = db.relationship("Reservation", back_populates="pets", cascade="delete, all")
